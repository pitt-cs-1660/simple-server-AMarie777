...
async def create_task(task_data: TaskCreate):
    ...
    conn.close()
    #return database row as taskread object
...
async def get_tasks():
    ...
    conn.close()
    #return list of tasks as taskread objs
    return [TaskRead(**dict(t)) for t in rows]
    #raise HTTPException(status_code=status.HTTP_501_NOT_IMPLEMENTED, detail="Not implemented")
...
async def update_task(task_id: int, task_data: TaskCreate):
    ...
    #return updated task data as TaskRead obj
    return TaskRead(**dict(row))
    #raise HTTPException(status_code=status.HTTP_501_NOT_IMPLEMENTED, detail="Not implemented")
